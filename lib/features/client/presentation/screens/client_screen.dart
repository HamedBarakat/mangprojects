...
final clientProjectsProvider = StreamProvider.family<List<Map<String, dynamic>>, String>(
  (ref, clientId) {
...
class ClientScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final projectsAsync = ref.watch(clientProjectsProvider(user.uid));
...
class _StatsBanner extends StatelessWidget {
  ...
  const _StatsBanner({required this.total, required this.active, required this.completed});
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Row(
        children: [
          _StatItem('Total', total.toString(), Icons.folder_outlined, Colors.white),
          _Divider(),
          _StatItem('Active', active.toString(), Icons.play_circle_outline, Colors.greenAccent),
          _Divider(),
          _StatItem('Done', completed.toString(), Icons.check_circle_outline, Colors.lightBlueAccent),
        ],
      ),
    );
  }
...
class _ProjectCard extends StatelessWidget {
  ...
  const _ProjectCard({required this.project, required this.clientId, required this.onTap});
          ...
          children: [
            ...
            Container(
              ...
              child: Row(children: [
                Container(
                  ...
                  child: Icon(Icons.business_center_outlined, color: _statusColor(status, cs), size: 22),
                ),
                ...
                Expanded(child: Column(
                  ...
                  children: [
                    ...
                    if (code.isNotEmpty)
                      Text(code, style: TextStyle(fontSize: 11, color: cs.onSurface.withOpacity(0.5))),
                  ],
                )),
                _StatusBadge(status),
              ]),
            ...
            Padding(
              ...
              child: Row(
                ...
                children: [
                  Text('Progress', style: TextStyle(fontSize: 12, color: cs.onSurface.withOpacity(0.55))),
                  Text('${progress.toStringAsFixed(0)}%',
                      style: TextStyle(fontSize: 12, fontWeight: FontWeight.bold, color: _statusColor(status, cs))),
                ],
              ),
            ),
            Padding(
            ...
            Padding(
              ...
              child: Row(children: [
                Icon(Icons.calendar_today_outlined, size: 13, color: cs.onSurface.withOpacity(0.45)),
      ...
      child: Column(
        ...
        children: [
          Container(
            ...
            child: Icon(Icons.folder_open_outlined, size: 44, color: cs.primary.withOpacity(0.6)),
          ),
