...
class UserModel {
  ...
  bool get isDC => role == 'dc'; // Document Controller

  // ── يشوف كل المشاريع والتاسكات بغض النظر عن التعيين ─────────────────────
  // Admin + QC (reviewer) + Management + DC + Section Head (head_of_department)
